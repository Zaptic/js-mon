...
import { extendedPromise } from './extendPromise'
...
export class MaybeObjectPromise<T extends {}> extends MaybePromise<T> {
    public static build<T>(promise: Promise<Maybe<T>>): MaybeObjectPromise<T> {
...
export class MaybeObjectResultPromise<E, T extends {}> extends ResultPromise<E, Maybe<T>> {
    public static build<E, T>(promise: ResultPromise<E, Maybe<T>>): MaybeObjectResultPromise<E, T> {
...
export class ObjectArrayPromise<T extends {}> extends ValueArrayPromise<T> {
    public static build<T>(promise: Promise<T[]>): ObjectArrayPromise<T> {
...
export class ObjectArrayResultPromise<E, T extends {}> extends ValueArrayResultPromise<E, T> {
    public static build<E, T>(promise: ResultPromise<E, T[]>): ObjectArrayResultPromise<E, T> {
